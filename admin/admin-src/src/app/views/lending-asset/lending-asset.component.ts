...
@Component({
  selector: 'app-lending-asset',
  templateUrl: './lending-asset.component.html',
  styleUrls: ['./lending-asset.component.scss']
})

export class LendingAssetComponent implements OnInit {
    ...
    resetuserlist(){
      ...
      this.loading = true;
      this.CommonService.requestData('lending/lending_assest_list',lstinput)
      .subscribe(resData => {
